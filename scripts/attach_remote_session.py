...
def main():
    ...
    parser.add_argument("--list", action="store_true", help="List all available tmux sessions and exit.")
    parser.add_argument("--logs", action="store_true", help="Show recent logs from the session instead of attaching.")
    parser.add_argument("--lines", type=int, default=100, help="Number of log lines to show with --logs (default: 100).")
